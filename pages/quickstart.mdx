...
Then, enter your access token from above into the "Parameters" section.


In the "Parameters" section, set `item_id` to `ce-wildfire-risk-static-us-and-canada-v3.0`. Then hit send!
